...
class AboutApi(object):
    ...
    def get_about(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_about(callback=callback_function)
        ...
        if kwargs.get('callback'):
            return self.get_about_with_http_info(**kwargs)
        else:
            (data) = self.get_about_with_http_info(**kwargs)
            return data
    ...
    def get_about_with_http_info(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_about_with_http_info(callback=callback_function)
