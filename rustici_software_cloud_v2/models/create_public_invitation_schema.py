...
class CreatePublicInvitationSchema(object):
    ...
    """
    def __init__(self, course_id=None, creating_user_email=None, registration_cap=0, post_back=None, expiration_date=None, tags=None):
        """
        CreatePublicInvitationSchema - a model defined in Swagger
    ...
    def course_id(self):
        """
        Gets the course_id of this CreatePublicInvitationSchema.
        The id of the course for which to create an invitation.

        :return: The course_id of this CreatePublicInvitationSchema.
        :rtype: str
        """
    ...
    def course_id(self, course_id):
        ...
        :param course_id: The course_id of this CreatePublicInvitationSchema.
        :type: str
        """
    ...
    def creating_user_email(self):
        """
        Gets the creating_user_email of this CreatePublicInvitationSchema.
        The email of the user who is creating the invitation.

        :return: The creating_user_email of this CreatePublicInvitationSchema.
        :rtype: str
        """
    ...
    def creating_user_email(self, creating_user_email):
        ...
        :param creating_user_email: The creating_user_email of this CreatePublicInvitationSchema.
        :type: str
        """
    ...
    def registration_cap(self):
        """
        Gets the registration_cap of this CreatePublicInvitationSchema.
        Integer value that limits the amount of registrations a public invitation can generate.

        :return: The registration_cap of this CreatePublicInvitationSchema.
        :rtype: int
        """
    ...
    def registration_cap(self, registration_cap):
        ...
        :param registration_cap: The registration_cap of this CreatePublicInvitationSchema.
        :type: int
        """
    ...
    def post_back(self):
        """
        Gets the post_back of this CreatePublicInvitationSchema.
        Specifies a URL for which to post activity and status data in real time as the course is completed

        :return: The post_back of this CreatePublicInvitationSchema.
    ...
    def post_back(self, post_back):
        ...
        :param post_back: The post_back of this CreatePublicInvitationSchema.
        :type: PostBackSchema
        """
    ...
    def expiration_date(self):
        """
        Gets the expiration_date of this CreatePublicInvitationSchema.
        The date this invitation will expire and can no longer be launched (formatted yyyyMMddHHmmss in UTC time).

        :return: The expiration_date of this CreatePublicInvitationSchema.
        :rtype: datetime
        """
    ...
    def expiration_date(self, expiration_date):
        ...
        :param expiration_date: The expiration_date of this CreatePublicInvitationSchema.
        :type: datetime
        """
    ...
    def tags(self):
        """
        Gets the tags of this CreatePublicInvitationSchema.
        Optional tags to be applied to this invitation.

        :return: The tags of this CreatePublicInvitationSchema.
        :rtype: list[str]
        """
        return self._tags
    ...
    def tags(self, tags):
        ...
        :param tags: The tags of this CreatePublicInvitationSchema.
        :type: list[str]
        """
