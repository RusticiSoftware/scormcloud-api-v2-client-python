...
class XapiCredentialPostSchema(object):
    ...
    def __init__(self, name=None, info=None, secret=None, is_enabled=None, auth=None, permissions_level=None):  # noqa: E501
        """XapiCredentialPostSchema - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(XapiCredentialPostSchema, dict):
