...
class TestTitleSchema(unittest.TestCase):
    """ TitleSchema unit test stubs """
    ...
    def testTitleSchema(self):
        """
        Test TitleSchema
        """
        model = rustici_software_cloud_v2.models.title_schema.TitleSchema()
