...
class TestApplicationSchema(unittest.TestCase):
    """ ApplicationSchema unit test stubs """
    ...
    def testApplicationSchema(self):
        """
        Test ApplicationSchema
        """
        model = rustici_software_cloud_v2.models.application_schema.ApplicationSchema()
